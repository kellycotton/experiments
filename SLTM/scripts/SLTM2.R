...
SIdata = read.table('Data/allSLTM2.txt',sep='') #Data for first part of experiment (stimulus identification)
LTMdata = read.table('Data/allSLTM2LTM.txt',sep='') #Data for the second part of the experiment (long-term memory)
...
#SI
png("acc_2.png", units="in", width=6, height=3, res=300)
...
#SI
png("rt_2.png", units="in", width=6, height=3, res=300)
...
#**Confidence----
png("conf_2.png", units="in", width=5, height=3, res=300)
print(
