...
function startLoopBegin(thisScheduler) {
  ...
  for (const thisStart of start) {
    ...
    thisScheduler.add(setupRoutineBegin(snapshot));
    thisScheduler.add(setupRoutineEachFrame(snapshot));
    thisScheduler.add(setupRoutineEnd(snapshot));
...
function practice_si_loopLoopBegin(thisScheduler) {
  ...
  for (const thisPractice_si_loop of practice_si_loop) {
    ...
    thisScheduler.add(importConditions(snapshot));
    thisScheduler.add(practice_siRoutineBegin(snapshot));
    thisScheduler.add(practice_siRoutineEachFrame(snapshot));
    thisScheduler.add(practice_siRoutineEnd(snapshot));
    thisScheduler.add(endLoopIteration(thisScheduler, snapshot));
  }
...
var blocks_si;
function blocks_siLoopBegin(thisScheduler) {
  // set up handler to look after randomisation of conditions etc
  ...
  for (const thisBlocks_si of blocks_si) {
    ...
    thisScheduler.add(importConditions(snapshot));
    thisScheduler.add(instructions_siRoutineBegin(snapshot));
    thisScheduler.add(instructions_siRoutineEachFrame(snapshot));
    thisScheduler.add(instructions_siRoutineEnd(snapshot));
    thisScheduler.add(si_key_positionsRoutineBegin(snapshot));
    thisScheduler.add(si_key_positionsRoutineEachFrame(snapshot));
    thisScheduler.add(si_key_positionsRoutineEnd(snapshot));
    const trial_siLoopScheduler = new Scheduler(psychoJS);
    thisScheduler.add(trial_siLoopBegin, trial_siLoopScheduler);
    thisScheduler.add(trial_siLoopScheduler);
    thisScheduler.add(trial_siLoopEnd);
    thisScheduler.add(end_block_siRoutineBegin(snapshot));
    thisScheduler.add(end_block_siRoutineEachFrame(snapshot));
    thisScheduler.add(end_block_siRoutineEnd(snapshot));
    thisScheduler.add(endLoopIteration(thisScheduler, snapshot));
  }
...
var trial_si;
function trial_siLoopBegin(thisScheduler) {
  // set up handler to look after randomisation of conditions etc
  ...
  for (const thisTrial_si of trial_si) {
    ...
    thisScheduler.add(importConditions(snapshot));
    thisScheduler.add(stimulus_identificationRoutineBegin(snapshot));
    thisScheduler.add(stimulus_identificationRoutineEachFrame(snapshot));
    thisScheduler.add(stimulus_identificationRoutineEnd(snapshot));
    thisScheduler.add(endLoopIteration(thisScheduler, snapshot));
  }
...
function trialsLoopBegin(thisScheduler) {
  ...
  for (const thisTrial of trials) {
    ...
    thisScheduler.add(importConditions(snapshot));
    thisScheduler.add(gough_scaleRoutineBegin(snapshot));
    thisScheduler.add(gough_scaleRoutineEachFrame(snapshot));
    thisScheduler.add(gough_scaleRoutineEnd(snapshot));
    thisScheduler.add(endLoopIteration(thisScheduler, snapshot));
  }
...
var rat_setup_stim;
function rat_setup_stimLoopBegin(thisScheduler) {
  // set up handler to look after randomisation of conditions etc
  ...
  for (const thisRat_setup_stim of rat_setup_stim) {
    ...
    thisScheduler.add(importConditions(snapshot));
    thisScheduler.add(rat_setupRoutineBegin(snapshot));
    thisScheduler.add(rat_setupRoutineEachFrame(snapshot));
    thisScheduler.add(rat_setupRoutineEnd(snapshot));
    thisScheduler.add(endLoopIteration(thisScheduler, snapshot));
  }
...
var trials_rat;
function trials_ratLoopBegin(thisScheduler) {
  // set up handler to look after randomisation of conditions etc
  ...
  for (const thisTrials_rat of trials_rat) {
    ...
    thisScheduler.add(importConditions(snapshot));
    thisScheduler.add(rat_testRoutineBegin(snapshot));
    thisScheduler.add(rat_testRoutineEachFrame(snapshot));
    thisScheduler.add(rat_testRoutineEnd(snapshot));
    thisScheduler.add(endLoopIteration(thisScheduler, snapshot));
  }
...
var trial_ltm;
function trial_ltmLoopBegin(thisScheduler) {
  // set up handler to look after randomisation of conditions etc
  ...
  for (const thisTrial_ltm of trial_ltm) {
    ...
    thisScheduler.add(importConditions(snapshot));
    thisScheduler.add(recognition_testRoutineBegin(snapshot));
    thisScheduler.add(recognition_testRoutineEachFrame(snapshot));
    thisScheduler.add(recognition_testRoutineEnd(snapshot));
    thisScheduler.add(endLoopIteration(thisScheduler, snapshot));
  }
...
function instructions_si_practiceRoutineBegin(trials) {
  return function () {
...
function instructions_si_practiceRoutineEachFrame(trials) {
  return function () {
...
function instructions_si_practiceRoutineEnd(trials) {
  return function () {
...
function si_key_positionsRoutineBegin(trials) {
  return function () {
...
function si_key_positionsRoutineEachFrame(trials) {
  return function () {
...
function si_key_positionsRoutineEnd(trials) {
  return function () {
...
function practice_siRoutineBegin(trials) {
  return function () {
...
var frameRemains;
function practice_siRoutineEachFrame(trials) {
  return function () {
...
var correct_ans;
function practice_siRoutineEnd(trials) {
  return function () {
...
function instructions_siRoutineBegin(trials) {
  return function () {
...
function instructions_siRoutineEachFrame(trials) {
  return function () {
...
function instructions_siRoutineEnd(trials) {
  return function () {
...
function stimulus_identificationRoutineBegin(trials) {
  return function () {
...
function stimulus_identificationRoutineEachFrame(trials) {
  return function () {
...
function stimulus_identificationRoutineEnd(trials) {
  return function () {
...
function end_block_siRoutineBegin(trials) {
  return function () {
...
function end_block_siRoutineEachFrame(trials) {
  return function () {
...
function end_block_siRoutineEnd(trials) {
  return function () {
...
function gough_scaleRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of gough_scaleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function gough_scaleRoutineEachFrame(trials) {
  return function () {
...
function gough_scaleRoutineEnd(trials) {
  return function () {
...
function rat_setupRoutineBegin(trials) {
  return function () {
...
function rat_setupRoutineEachFrame(trials) {
  return function () {
...
function rat_setupRoutineEnd(trials) {
  return function () {
...
function instructions_ratRoutineBegin(trials) {
  return function () {
...
function instructions_ratRoutineEachFrame(trials) {
  return function () {
...
function instructions_ratRoutineEnd(trials) {
  return function () {
...
function rat_testRoutineBegin(trials) {
  return function () {
...
var textAdd;
var tempText;
function rat_testRoutineEachFrame(trials) {
  return function () {
...
function rat_testRoutineEnd(trials) {
  return function () {
...
function instructions_ltmRoutineBegin(trials) {
  return function () {
...
function instructions_ltmRoutineEachFrame(trials) {
  return function () {
...
function instructions_ltmRoutineEnd(trials) {
  return function () {
...
function recognition_testRoutineBegin(trials) {
  return function () {
...
function recognition_testRoutineEachFrame(trials) {
  return function () {
...
var distractor_pos;
var target_pos;
function recognition_testRoutineEnd(trials) {
  return function () {
