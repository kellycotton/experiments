...
let expName = 'omg1';  // from the Builder filename that created this script
...
var target_text_practice;
var lure_text_practice;
...
async function experimentInit() {
  ...
  lure_text_practice = new visual.TextStim({
    win: psychoJS.window,
    name: 'lure_text_practice',
    text: '',
    font: 'Open Sans',
    units: undefined, 
    pos: [0, 0], height: 0.05,  wrapWidth: undefined, ori: 0.0,
  ...
  target_text_wm = new visual.TextStim({
    win: psychoJS.window,
    name: 'target_text_wm',
    text: '',
    font: 'Open Sans',
  ...
  lure_text_wm = new visual.TextStim({
    win: psychoJS.window,
    name: 'lure_text_wm',
    text: '',
    font: 'Open Sans',
  ...
  key_resp_wm = new core.Keyboard({psychoJS: psychoJS, clock: new util.Clock(), waitForStart: true});
  ...
  target_text_delay = new visual.TextStim({
    win: psychoJS.window,
    name: 'target_text_delay',
    text: '',
    font: 'Open Sans',
    units: undefined, 
    pos: [0, 0], height: 0.05,  wrapWidth: undefined, ori: 0.0,
  ...
  lure_text_delay = new visual.TextStim({
    win: psychoJS.window,
    name: 'lure_text_delay',
    text: '',
    font: 'Open Sans',
    units: undefined, 
    pos: [0, 0], height: 0.05,  wrapWidth: undefined, ori: 0.0,
...
function practice_1LoopBegin(practice_1LoopScheduler, snapshot) {
  return async function() {
    ...
    practice_1.forEach(function() {
      ...
      practice_1LoopScheduler.add(test_setupRoutineBegin(snapshot));
      practice_1LoopScheduler.add(test_setupRoutineEachFrame());
      practice_1LoopScheduler.add(test_setupRoutineEnd());
...
function practice_1_presentLoopBegin(practice_1_presentLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    practice_1_present.forEach(function() {
...
function practice_test_1LoopBegin(practice_test_1LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    practice_test_1.forEach(function() {
...
function practice_3LoopBegin(practice_3LoopScheduler, snapshot) {
  return async function() {
    ...
    practice_3.forEach(function() {
      ...
      practice_3LoopScheduler.add(test_setupRoutineBegin(snapshot));
      practice_3LoopScheduler.add(test_setupRoutineEachFrame());
      practice_3LoopScheduler.add(test_setupRoutineEnd());
...
function stim_presentation_practiceLoopBegin(stim_presentation_practiceLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    stim_presentation_practice.forEach(function() {
...
function practice_parityLoopBegin(practice_parityLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    practice_parity.forEach(function() {
...
function practice_test_2LoopBegin(practice_test_2LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    practice_test_2.forEach(function() {
...
function block_immediateLoopBegin(block_immediateLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    block_immediate.forEach(function() {
      const snapshot = block_immediate.getSnapshot();
    
      block_immediateLoopScheduler.add(importConditions(snapshot));
      block_immediateLoopScheduler.add(remindRoutineBegin(snapshot));
      block_immediateLoopScheduler.add(remindRoutineEachFrame());
      block_immediateLoopScheduler.add(remindRoutineEnd());
...
function trials_immediateLoopBegin(trials_immediateLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    trials_immediate.forEach(function() {
      ...
      trials_immediateLoopScheduler.add(test_setupRoutineBegin(snapshot));
      trials_immediateLoopScheduler.add(test_setupRoutineEachFrame());
      trials_immediateLoopScheduler.add(test_setupRoutineEnd());
...
function stim_presentation_loopLoopBegin(stim_presentation_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    stim_presentation_loop.forEach(function() {
...
function test_immediate_loopLoopBegin(test_immediate_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    test_immediate_loop.forEach(function() {
...
function block_distractLoopBegin(block_distractLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    block_distract.forEach(function() {
...
function exp_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    exp_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_setupRoutineBegin(snapshot) {
  return async function () {
    ...
    resp_i = 0;
    parity_n = 0;
    psychoJS.experiment.addData("trial_words", trial_words);
    words_presented_wm = [];
    score_hide = 0;
...
function stim_present_practiceRoutineBegin(snapshot) {
  return async function () {
    ...
    words_presented_wm.push([word_present, stim_n]);
    ...
    stim_present_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
var test_setupComponents;
function test_setupRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //------Prepare to start Routine 'test_setup'-------
    t = 0;
    test_setupClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    util.shuffle(words_presented_wm);
    
    // keep track of which components have finished
    test_setupComponents = [];
    
    test_setupComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_setupRoutineEachFrame() {
  return async function () {
    //------Loop for each frame of Routine 'test_setup'-------
    // get current time
...
function test_immediate_practiceRoutineBegin(snapshot) {
  return async function () {
    ...
    test_immediate_practiceComponents.push(target_text_practice);
    test_immediate_practiceComponents.push(lure_text_practice);
    test_immediate_practiceComponents.push(key_resp_practice);
    test_immediate_practiceComponents.push(text_6);
    
    test_immediate_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_immediate_practiceRoutineEachFrame() {
  return async function () {
    ...
    if (t >= 0.0 && target_text_practice.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      target_text_practice.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && lure_text_practice.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lure_text_practice.tStart = t;  // (not accounting for frame time here)
    ...
    if (key_resp_practice.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_practice.getKeys({keyList: ['left', 'right'], waitRelease: false});
      ...
      if (_key_resp_practice_allKeys.length > 0) {
        ...
        // was this correct?
        if (key_resp_practice.keys == corr_ans_wm) {
...
function test_immediate_practiceRoutineEnd() {
  return async function () {
    ...
    if (key_resp_practice.keys === undefined) {
      if (['None','none',undefined].includes(corr_ans_wm)) {
    ...
    if (psychoJS.experiment.currentLoop instanceof MultiStairHandler) {
      psychoJS.experiment.currentLoop.addResponse(key_resp_practice.corr, level);
    }
...
function feedback_1RoutineBegin(snapshot) {
  return async function () {
    ...
    if ((current_score === trial_length)) {
        ...
        if ((current_score > 0)) {
            feedback_msg = (("You answered " + current_score.toString()) + " correctly. Press SPACE to continue.");
        } else {
...
function parity_practiceRoutineBegin(snapshot) {
  return async function () {
    ...
    parity_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_instructions_3RoutineBegin(snapshot) {
  return async function () {
    ...
    practice_instructions_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function remindRoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of which components have finished
    remindComponents = [];
    remindComponents.push(text_15);
    remindComponents.push(key_resp_3);
...
function stim_presentRoutineBegin(snapshot) {
  return async function () {
    ...
    stim_presentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_immediateRoutineBegin(snapshot) {
  return async function () {
    ...
    key_resp_wm.keys = undefined;
    key_resp_wm.rt = undefined;
    _key_resp_wm_allKeys = [];
    // keep track of which components have finished
    test_immediateComponents = [];
    test_immediateComponents.push(target_text_wm);
    test_immediateComponents.push(lure_text_wm);
    test_immediateComponents.push(key_resp_wm);
    test_immediateComponents.push(text_18);
    
    test_immediateComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_immediateRoutineEachFrame() {
  return async function () {
    ...
    if (t >= 0.0 && target_text_wm.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      target_text_wm.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && lure_text_wm.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lure_text_wm.tStart = t;  // (not accounting for frame time here)
    ...
    // *key_resp_wm* updates
    if (t >= 0.0 && key_resp_wm.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      key_resp_wm.tStart = t;  // (not accounting for frame time here)
      key_resp_wm.frameNStart = frameN;  // exact frame index
      
      // keyboard checking is just starting
      psychoJS.window.callOnFlip(function() { key_resp_wm.clock.reset(); });  // t=0 on next screen flip
      psychoJS.window.callOnFlip(function() { key_resp_wm.start(); }); // start on screen flip
      psychoJS.window.callOnFlip(function() { key_resp_wm.clearEvents(); });
    }

    if (key_resp_wm.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_wm.getKeys({keyList: ['left', 'right'], waitRelease: false});
      _key_resp_wm_allKeys = _key_resp_wm_allKeys.concat(theseKeys);
      if (_key_resp_wm_allKeys.length > 0) {
        key_resp_wm.keys = _key_resp_wm_allKeys[_key_resp_wm_allKeys.length - 1].name;  // just the last key pressed
        key_resp_wm.rt = _key_resp_wm_allKeys[_key_resp_wm_allKeys.length - 1].rt;
        // was this correct?
        if (key_resp_wm.keys == corr_ans_wm) {
            key_resp_wm.corr = 1;
        } else {
            key_resp_wm.corr = 0;
        }
...
function test_immediateRoutineEnd() {
  return async function () {
    ...
    psychoJS.experiment.addData("trial_n", trial_n);
    psychoJS.experiment.addData("block_n", block_n);
    psychoJS.experiment.addData("presented_word", target_word);
    psychoJS.experiment.addData("presented_serial_position", words_presented_wm[resp_i][1]);
    ...
    // update the trial handler
    if (psychoJS.experiment.currentLoop instanceof MultiStairHandler) {
      psychoJS.experiment.currentLoop.addResponse(key_resp_wm.corr, level);
    }
    psychoJS.experiment.addData('key_resp_wm.keys', key_resp_wm.keys);
    psychoJS.experiment.addData('key_resp_wm.corr', key_resp_wm.corr);
    if (typeof key_resp_wm.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('key_resp_wm.rt', key_resp_wm.rt);
        routineTimer.reset();
        }
...
function end_blockRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    if ((score_hide !== 1)) {
        score_msg = (("You correctly answered " + Math.round(((current_score / (trial_length * trial_total)) * 100)).toString()) + "% during this block.");
    } else {
        score_msg = "";
    }
    ...
    end_blockComponents.push(text_14);
...
function distract_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    distract_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function distract_remindRoutineBegin(snapshot) {
  return async function () {
    ...
    distract_remindComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function go_nogo_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    go_nogo_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ltm_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    ltm_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stim_present_delayRoutineBegin(snapshot) {
  return async function () {
    ...
    stim_present_delayComponents.push(target_text_delay);
    stim_present_delayComponents.push(lure_text_delay);
    stim_present_delayComponents.push(key_resp_ltm);
    stim_present_delayComponents.push(text_19);
    
    stim_present_delayComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stim_present_delayRoutineEachFrame() {
  return async function () {
    ...
    if (t >= 0.0 && target_text_delay.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      target_text_delay.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && lure_text_delay.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      lure_text_delay.tStart = t;  // (not accounting for frame time here)
...
function continue_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    continue_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
