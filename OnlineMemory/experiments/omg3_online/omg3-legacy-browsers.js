...
function practice_instruct_1RoutineBegin(snapshot) {
  return async function () {
    ...
    practice_instruct_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trials_experimentalLoopBegin(trials_experimentalLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    trials_experimental.forEach(function() {
...
function stim_1RoutineBegin(snapshot) {
  return async function () {
    ...
    stim_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stim_2RoutineBegin(snapshot) {
  return async function () {
    ...
    stim_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stim_3RoutineBegin(snapshot) {
  return async function () {
    ...
    stim_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
