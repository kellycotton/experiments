...
let expName = 'WMB1';  // from the Builder filename that created this script
...
function experimentInit() {
  ...
  test5 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'test5', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0, pos : [0, 0], size : [0.1, 0.1],
    color : new util.Color([1, 1, 1]), opacity : 1.0,
    flipHoriz : false, flipVert : false,
  ...
  test6 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'test6', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0, pos : [0, 0], size : [0.1, 0.1],
    color : new util.Color([1, 1, 1]), opacity : 1.0,
    flipHoriz : false, flipVert : false,
  ...
  feedback_test_4 = new visual.ImageStim({
    ...
    color : new util.Color([1, 1, 1]), opacity : 1.0,
    flipHoriz : false, flipVert : false,
    texRes : 512, interpolate : true, depth : -16.0 
  });
  feedback_test_5 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'feedback_test_5', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0, pos : [0, 0], size : [0.1, 0.1],
    color : new util.Color([1, 1, 1]), opacity : 1.0,
    flipHoriz : false, flipVert : false,
  ...
  feedback_test_6 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'feedback_test_6', units : undefined, 
    image : undefined, mask : undefined,
    ori : 0, pos : [0, 0], size : [0.1, 0.1],
    color : new util.Color([1, 1, 1]), opacity : 1.0,
    flipHoriz : false, flipVert : false,
    texRes : 512, interpolate : true, depth : -18.0 
  });
...
function trialRoutineEnd(trials) {
  return function () {
    ...
    if ((setsize === 3)) {
        pos = [stim1.pos, stim2.pos, stim3.pos];
        test_positions = get_test_positions(pos);
        test_positions.push(stim4.pos, stim5.pos, stim6.pos);
    } else {
        pos = [stim1.pos, stim2.pos, stim3.pos, stim4.pos, stim5.pos, stim6.pos];
        test_positions = get_test_positions(pos);
    }
...
function testRoutineBegin(trials) {
  return function () {
    ...
    test5.setOpacity(visibility);
    test5.setPos(test_positions[4]);
    test5.setImage(stimuli[4]);
    test6.setOpacity(visibility);
    test6.setPos(test_positions[5]);
    test6.setImage(stimuli[5]);
    ...
    testComponents.push(test5);
    testComponents.push(test6);
...
function testRoutineEachFrame(trials) {
  return function () {
    ...
    // *test2* updates
    if (t >= 1.8 && test2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    // *test3* updates
    if (t >= 1.8 && test3.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    // *test4* updates
    if (t >= 1.8 && test4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
    ...
    // *test5* updates
    if (t >= 1.8 && test5.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      test5.tStart = t;  // (not accounting for frame time here)
      test5.frameNStart = frameN;  // exact frame index
      
      test5.setAutoDraw(true);
    }

    
    // *test6* updates
    if (t >= 1.8 && test6.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      test6.tStart = t;  // (not accounting for frame time here)
      test6.frameNStart = frameN;  // exact frame index
      
      test6.setAutoDraw(true);
    }
...
function feedbackRoutineBegin(trials) {
  return function () {
    ...
    feedback_test_positions = [[(test_positions[0][0] + 0.4), test_positions[0][1]], [(test_positions[1][0] + 0.4), test_positions[1][1]], [(test_positions[2][0] + 0.4), test_positions[2][1]], [(test_positions[3][0] + 0.4), test_positions[3][1]], [(test_positions[4][0] + 0.4), test_positions[4][1]], [(test_positions[5][0] + 0.4), test_positions[5][1]]];
    ...
    feedback_test_5.setOpacity(visibility);
    feedback_test_5.setPos(feedback_test_positions[4]);
    feedback_test_5.setImage(stimuli[4]);
    feedback_test_6.setOpacity(visibility);
    feedback_test_6.setPos(feedback_test_positions[5]);
    feedback_test_6.setImage(stimuli[5]);
    // keep track of which components have finished
    feedbackComponents = [];
    ...
    feedbackComponents.push(feedback_test_5);
    feedbackComponents.push(feedback_test_6);
...
function feedbackRoutineEachFrame(trials) {
  return function () {
    ...
    // *feedback_test_5* updates
    if (t >= 0 && feedback_test_5.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      feedback_test_5.tStart = t;  // (not accounting for frame time here)
      feedback_test_5.frameNStart = frameN;  // exact frame index
      
      feedback_test_5.setAutoDraw(true);
    }

    
    // *feedback_test_6* updates
    if (t >= 0 && feedback_test_6.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      feedback_test_6.tStart = t;  // (not accounting for frame time here)
      feedback_test_6.frameNStart = frameN;  // exact frame index
      
      feedback_test_6.setAutoDraw(true);
    }
