...
expName = 'MDMW4-1'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'version': '4.1',
    'site': 'usd',
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/kellycotton/Dropbox/Research/Mind-Wandering/MindWandering/mdmw4-1_usd/MDMW4-1_usd_lastrun.py',
...
practice_presentation_2Clock = core.Clock()
stim2_3 = visual.Rect(
    win=win, name='stim2_3',
    width=(0.05, 0.05)[0], height=(0.05, 0.05)[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=0.0, interpolate=True)
mask2_8 = visual.Rect(
    win=win, name='mask2_8',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-1.0, interpolate=True)
mask2_9 = visual.Rect(
    win=win, name='mask2_9',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-2.0, interpolate=True)
mask2_10 = visual.Rect(
    win=win, name='mask2_10',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-3.0, interpolate=True)
mask2_11 = visual.Rect(
    win=win, name='mask2_11',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-4.0, interpolate=True)
...
practice_presentation_3Clock = core.Clock()
stim3_4 = visual.Rect(
    win=win, name='stim3_4',
    width=(0.05, 0.05)[0], height=(0.05, 0.05)[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=0.0, interpolate=True)
mask3_12 = visual.Rect(
    win=win, name='mask3_12',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-1.0, interpolate=True)
mask3_13 = visual.Rect(
    win=win, name='mask3_13',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-2.0, interpolate=True)
mask3_14 = visual.Rect(
    win=win, name='mask3_14',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-3.0, interpolate=True)
mask3_15 = visual.Rect(
    win=win, name='mask3_15',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-4.0, interpolate=True)
...
practice_presentation_4Clock = core.Clock()
stim4_2 = visual.Rect(
    ...
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=0.0, interpolate=True)
mask4_16 = visual.Rect(
    win=win, name='mask4_16',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-1.0, interpolate=True)
mask4_17 = visual.Rect(
    win=win, name='mask4_17',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-2.0, interpolate=True)
mask4_18 = visual.Rect(
    win=win, name='mask4_18',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-3.0, interpolate=True)
mask4_19 = visual.Rect(
    win=win, name='mask4_19',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-4.0, interpolate=True)
...
stimulus_presentation_4Clock = core.Clock()
stim4_5 = visual.Rect(
    win=win, name='stim4_5',
    width=(0.05, 0.05)[0], height=(0.05, 0.05)[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=0.0, interpolate=True)
mask4_12 = visual.Rect(
    win=win, name='mask4_12',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-1.0, interpolate=True)
mask4_13 = visual.Rect(
    win=win, name='mask4_13',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-2.0, interpolate=True)
mask4_14 = visual.Rect(
    win=win, name='mask4_14',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-3.0, interpolate=True)
mask4_15 = visual.Rect(
    win=win, name='mask4_15',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-4.0, interpolate=True)
...
stimulus_presentation_2Clock = core.Clock()
stim2_2 = visual.Rect(
...
stimulus_presentation_3Clock = core.Clock()
stim3_3 = visual.Rect(
    win=win, name='stim3_3',
    width=(0.05, 0.05)[0], height=(0.05, 0.05)[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=0.0, interpolate=True)
mask3_8 = visual.Rect(
    win=win, name='mask3_8',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-1.0, interpolate=True)
mask3_9 = visual.Rect(
    win=win, name='mask3_9',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-2.0, interpolate=True)
mask3_10 = visual.Rect(
    win=win, name='mask3_10',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-3.0, interpolate=True)
mask3_11 = visual.Rect(
    win=win, name='mask3_11',
    width=(mask_size[0], mask_size[1])[0], height=(mask_size[0], mask_size[1])[1],
    ori=0.0, pos=[0,0], anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=-4.0, interpolate=True)
...
trials_practice_presentation = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('exp_cond.xlsx', selection='3:6'),
...
for thisTrials_practice_presentation in trials_practice_presentation:
    ...
    # keep track of which components have finished
    practice_presentationComponents = [fixation_2, stim1_2, mask1, mask1_5, mask1_6, mask1_7]
    ...
    continueRoutine = True
    # update component parameters for each repeat
    stim2_3.setFillColor(colors[1])
    stim2_3.setPos([stim_positions[1]])
    stim2_3.setLineColor(colors[1])
    mask2_8.setFillColor(colors[5])
    mask2_8.setPos((stim_positions[1][0]-.0125, stim_positions[1][1]-.0125))
    mask2_8.setLineColor(colors[5])
    mask2_9.setFillColor(colors[6])
    mask2_9.setPos((stim_positions[1][0]+.0125, stim_positions[1][1]-.0125))
    mask2_9.setLineColor(colors[6])
    mask2_10.setFillColor(colors[7])
    mask2_10.setPos((stim_positions[1][0]+.0125, stim_positions[1][1]+.0125))
    mask2_10.setLineColor(colors[7])
    mask2_11.setFillColor(colors[8])
    mask2_11.setPos((stim_positions[1][0]-.0125, stim_positions[1][1]+.0125))
    mask2_11.setLineColor(colors[8])
    # keep track of which components have finished
    practice_presentation_2Components = [stim2_3, mask2_8, mask2_9, mask2_10, mask2_11]
    for thisComponent in practice_presentation_2Components:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    practice_presentation_2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "practice_presentation_2"-------
    while continueRoutine:
        # get current time
        t = practice_presentation_2Clock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=practice_presentation_2Clock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *stim2_3* updates
        if stim2_3.status == NOT_STARTED and tThisFlip >= fix_time-frameTolerance:
            # keep track of start time/frame for later
            stim2_3.frameNStart = frameN  # exact frame index
            stim2_3.tStart = t  # local t and not account for scr refresh
            stim2_3.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(stim2_3, 'tStartRefresh')  # time at next scr refresh
            stim2_3.setAutoDraw(True)
        if stim2_3.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > stim2_3.tStartRefresh + stim_time-frameTolerance:
                # keep track of stop time/frame for later
                stim2_3.tStop = t  # not accounting for scr refresh
                stim2_3.frameNStop = frameN  # exact frame index
                win.timeOnFlip(stim2_3, 'tStopRefresh')  # time at next scr refresh
                stim2_3.setAutoDraw(False)
        
        # *mask2_8* updates
        if mask2_8.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
        ...
        if mask2_8.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask2_8.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask2_8.tStop = t  # not accounting for scr refresh
                mask2_8.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask2_8, 'tStopRefresh')  # time at next scr refresh
                mask2_8.setAutoDraw(False)
        
        # *mask2_9* updates
        if mask2_9.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
        ...
        if mask2_9.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask2_9.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask2_9.tStop = t  # not accounting for scr refresh
                mask2_9.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask2_9, 'tStopRefresh')  # time at next scr refresh
                mask2_9.setAutoDraw(False)
        
        # *mask2_10* updates
        if mask2_10.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
        ...
        if mask2_10.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask2_10.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask2_10.tStop = t  # not accounting for scr refresh
                mask2_10.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask2_10, 'tStopRefresh')  # time at next scr refresh
                mask2_10.setAutoDraw(False)
        
        # *mask2_11* updates
        if mask2_11.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
        ...
        if mask2_11.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask2_11.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask2_11.tStop = t  # not accounting for scr refresh
                mask2_11.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask2_11, 'tStopRefresh')  # time at next scr refresh
    ...
    continueRoutine = True
    # update component parameters for each repeat
    stim3_4.setFillColor(colors[2])
    stim3_4.setPos([stim_positions[2]])
    stim3_4.setLineColor(colors[2])
    mask3_12.setFillColor(colors[5])
    mask3_12.setPos((stim_positions[2][0]-.0125, stim_positions[2][1]-.0125))
    mask3_12.setLineColor(colors[5])
    mask3_13.setFillColor(colors[6])
    mask3_13.setPos((stim_positions[2][0]+.0125, stim_positions[2][1]-.0125))
    mask3_13.setLineColor(colors[6])
    mask3_14.setFillColor(colors[7])
    mask3_14.setPos((stim_positions[2][0]+.0125, stim_positions[2][1]+.0125))
    mask3_14.setLineColor(colors[7])
    mask3_15.setFillColor(colors[8])
    mask3_15.setPos((stim_positions[2][0]-.0125, stim_positions[2][1]+.0125))
    mask3_15.setLineColor(colors[8])
    # keep track of which components have finished
    practice_presentation_3Components = [stim3_4, mask3_12, mask3_13, mask3_14, mask3_15]
    for thisComponent in practice_presentation_3Components:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    practice_presentation_3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "practice_presentation_3"-------
    while continueRoutine:
        # get current time
        t = practice_presentation_3Clock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=practice_presentation_3Clock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *stim3_4* updates
        if stim3_4.status == NOT_STARTED and tThisFlip >= fix_time-frameTolerance:
            # keep track of start time/frame for later
            stim3_4.frameNStart = frameN  # exact frame index
            stim3_4.tStart = t  # local t and not account for scr refresh
            stim3_4.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(stim3_4, 'tStartRefresh')  # time at next scr refresh
            stim3_4.setAutoDraw(True)
        if stim3_4.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > stim3_4.tStartRefresh + stim_time-frameTolerance:
                # keep track of stop time/frame for later
                stim3_4.tStop = t  # not accounting for scr refresh
                stim3_4.frameNStop = frameN  # exact frame index
                win.timeOnFlip(stim3_4, 'tStopRefresh')  # time at next scr refresh
                stim3_4.setAutoDraw(False)
        
        # *mask3_12* updates
        if mask3_12.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
        ...
        if mask3_12.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask3_12.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask3_12.tStop = t  # not accounting for scr refresh
                mask3_12.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask3_12, 'tStopRefresh')  # time at next scr refresh
                mask3_12.setAutoDraw(False)
        
        # *mask3_13* updates
        if mask3_13.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask3_13.frameNStart = frameN  # exact frame index
            mask3_13.tStart = t  # local t and not account for scr refresh
            mask3_13.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask3_13, 'tStartRefresh')  # time at next scr refresh
            mask3_13.setAutoDraw(True)
        if mask3_13.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask3_13.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask3_13.tStop = t  # not accounting for scr refresh
                mask3_13.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask3_13, 'tStopRefresh')  # time at next scr refresh
                mask3_13.setAutoDraw(False)
        
        # *mask3_14* updates
        if mask3_14.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask3_14.frameNStart = frameN  # exact frame index
            mask3_14.tStart = t  # local t and not account for scr refresh
            mask3_14.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask3_14, 'tStartRefresh')  # time at next scr refresh
            mask3_14.setAutoDraw(True)
        if mask3_14.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask3_14.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask3_14.tStop = t  # not accounting for scr refresh
                mask3_14.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask3_14, 'tStopRefresh')  # time at next scr refresh
                mask3_14.setAutoDraw(False)
        
        # *mask3_15* updates
        if mask3_15.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask3_15.frameNStart = frameN  # exact frame index
            mask3_15.tStart = t  # local t and not account for scr refresh
            mask3_15.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask3_15, 'tStartRefresh')  # time at next scr refresh
            mask3_15.setAutoDraw(True)
        if mask3_15.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask3_15.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask3_15.tStop = t  # not accounting for scr refresh
                mask3_15.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask3_15, 'tStopRefresh')  # time at next scr refresh
    ...
    mask4_16.setFillColor(colors[5])
    mask4_16.setPos((stim_positions[3][0]-.0125, stim_positions[3][1]-.0125))
    mask4_16.setLineColor(colors[5])
    mask4_17.setFillColor(colors[6])
    mask4_17.setPos((stim_positions[3][0]+.0125, stim_positions[3][1]-.0125))
    mask4_17.setLineColor(colors[6])
    mask4_18.setFillColor(colors[7])
    mask4_18.setPos((stim_positions[3][0]+.0125, stim_positions[3][1]+.0125))
    mask4_18.setLineColor(colors[7])
    mask4_19.setFillColor(colors[8])
    mask4_19.setPos((stim_positions[3][0]-.0125, stim_positions[3][1]+.0125))
    mask4_19.setLineColor(colors[8])
    # keep track of which components have finished
    practice_presentation_4Components = [stim4_2, mask4_16, mask4_17, mask4_18, mask4_19]
    for thisComponent in practice_presentation_4Components:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    practice_presentation_4Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "practice_presentation_4"-------
    while continueRoutine:
        # get current time
        t = practice_presentation_4Clock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=practice_presentation_4Clock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        # *mask4_16* updates
        if mask4_16.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask4_16.frameNStart = frameN  # exact frame index
            mask4_16.tStart = t  # local t and not account for scr refresh
            mask4_16.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask4_16, 'tStartRefresh')  # time at next scr refresh
            mask4_16.setAutoDraw(True)
        if mask4_16.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask4_16.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask4_16.tStop = t  # not accounting for scr refresh
                mask4_16.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask4_16, 'tStopRefresh')  # time at next scr refresh
                mask4_16.setAutoDraw(False)
        
        # *mask4_17* updates
        if mask4_17.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask4_17.frameNStart = frameN  # exact frame index
            mask4_17.tStart = t  # local t and not account for scr refresh
            mask4_17.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask4_17, 'tStartRefresh')  # time at next scr refresh
            mask4_17.setAutoDraw(True)
        if mask4_17.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask4_17.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask4_17.tStop = t  # not accounting for scr refresh
                mask4_17.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask4_17, 'tStopRefresh')  # time at next scr refresh
                mask4_17.setAutoDraw(False)
        
        # *mask4_18* updates
        if mask4_18.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask4_18.frameNStart = frameN  # exact frame index
            mask4_18.tStart = t  # local t and not account for scr refresh
            mask4_18.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask4_18, 'tStartRefresh')  # time at next scr refresh
            mask4_18.setAutoDraw(True)
        if mask4_18.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask4_18.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask4_18.tStop = t  # not accounting for scr refresh
                mask4_18.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask4_18, 'tStopRefresh')  # time at next scr refresh
                mask4_18.setAutoDraw(False)
        
        # *mask4_19* updates
        if mask4_19.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask4_19.frameNStart = frameN  # exact frame index
            mask4_19.tStart = t  # local t and not account for scr refresh
            mask4_19.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask4_19, 'tStartRefresh')  # time at next scr refresh
            mask4_19.setAutoDraw(True)
        if mask4_19.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask4_19.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask4_19.tStop = t  # not accounting for scr refresh
                mask4_19.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask4_19, 'tStopRefresh')  # time at next scr refresh
    ...
    # keep track of which components have finished
    practice_response_presentationComponents = [resp1_2, key_resp_prac, text_14]
    ...
    trials_practice_presentation.addData('text_14.started', text_14.tStartRefresh)
    trials_practice_presentation.addData('text_14.stopped', text_14.tStopRefresh)
...
for thisTrials_practice in trials_practice:
    ...
    # set up handler to look after randomisation of conditions etc
    trials_cogload_practice2_1 = data.TrialHandler(nReps=cognitive_load, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='trials_cogload_practice2_1')
    thisExp.addLoop(trials_cogload_practice2_1)  # add the loop to the experiment
    thisTrials_cogload_practice2_1 = trials_cogload_practice2_1.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_practice2_1.rgb)
    if thisTrials_cogload_practice2_1 != None:
        for paramName in thisTrials_cogload_practice2_1:
            exec('{} = thisTrials_cogload_practice2_1[paramName]'.format(paramName))
    
    for thisTrials_cogload_practice2_1 in trials_cogload_practice2_1:
        currentLoop = trials_cogload_practice2_1
        # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_practice2_1.rgb)
        if thisTrials_cogload_practice2_1 != None:
            for paramName in thisTrials_cogload_practice2_1:
                exec('{} = thisTrials_cogload_practice2_1[paramName]'.format(paramName))
        ...
        if key_resp_load_prac.keys in ['', [], None]:  # No response was made
            ...
            if str(correct_ans_cogload).lower() == 'none':
               ...
               key_resp_load_prac.corr = 0;  # failed to respond (incorrectly)
        # store data for trials_cogload_practice2_1 (TrialHandler)
        trials_cogload_practice2_1.addData('key_resp_load_prac.keys',key_resp_load_prac.keys)
        trials_cogload_practice2_1.addData('key_resp_load_prac.corr', key_resp_load_prac.corr)
        if key_resp_load_prac.keys != None:  # we had a response
            trials_cogload_practice2_1.addData('key_resp_load_prac.rt', key_resp_load_prac.rt)
        # the Routine "practice_cog_load" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
    # completed cognitive_load repeats of 'trials_cogload_practice2_1'
    ...
    # set up handler to look after randomisation of conditions etc
    trials_cogload_practice2_2 = data.TrialHandler(nReps=cognitive_load, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='trials_cogload_practice2_2')
    thisExp.addLoop(trials_cogload_practice2_2)  # add the loop to the experiment
    thisTrials_cogload_practice2_2 = trials_cogload_practice2_2.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_practice2_2.rgb)
    if thisTrials_cogload_practice2_2 != None:
        for paramName in thisTrials_cogload_practice2_2:
            exec('{} = thisTrials_cogload_practice2_2[paramName]'.format(paramName))
    
    for thisTrials_cogload_practice2_2 in trials_cogload_practice2_2:
        currentLoop = trials_cogload_practice2_2
        # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_practice2_2.rgb)
        if thisTrials_cogload_practice2_2 != None:
            for paramName in thisTrials_cogload_practice2_2:
                exec('{} = thisTrials_cogload_practice2_2[paramName]'.format(paramName))
        ...
        if key_resp_load_prac.keys in ['', [], None]:  # No response was made
            ...
            if str(correct_ans_cogload).lower() == 'none':
               ...
               key_resp_load_prac.corr = 0;  # failed to respond (incorrectly)
        # store data for trials_cogload_practice2_2 (TrialHandler)
        trials_cogload_practice2_2.addData('key_resp_load_prac.keys',key_resp_load_prac.keys)
        trials_cogload_practice2_2.addData('key_resp_load_prac.corr', key_resp_load_prac.corr)
        if key_resp_load_prac.keys != None:  # we had a response
            trials_cogload_practice2_2.addData('key_resp_load_prac.rt', key_resp_load_prac.rt)
        # the Routine "practice_cog_load" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
        
    # completed cognitive_load repeats of 'trials_cogload_practice2_2'
    ...
    # set up handler to look after randomisation of conditions etc
    trials_cogload_practice2_3 = data.TrialHandler(nReps=cognitive_load, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='trials_cogload_practice2_3')
    thisExp.addLoop(trials_cogload_practice2_3)  # add the loop to the experiment
    thisTrials_cogload_practice2_3 = trials_cogload_practice2_3.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_practice2_3.rgb)
    if thisTrials_cogload_practice2_3 != None:
        for paramName in thisTrials_cogload_practice2_3:
            exec('{} = thisTrials_cogload_practice2_3[paramName]'.format(paramName))
    
    for thisTrials_cogload_practice2_3 in trials_cogload_practice2_3:
        currentLoop = trials_cogload_practice2_3
        # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_practice2_3.rgb)
        if thisTrials_cogload_practice2_3 != None:
            for paramName in thisTrials_cogload_practice2_3:
                exec('{} = thisTrials_cogload_practice2_3[paramName]'.format(paramName))
        ...
        if key_resp_load_prac.keys in ['', [], None]:  # No response was made
            ...
            if str(correct_ans_cogload).lower() == 'none':
               ...
               key_resp_load_prac.corr = 0;  # failed to respond (incorrectly)
        # store data for trials_cogload_practice2_3 (TrialHandler)
        trials_cogload_practice2_3.addData('key_resp_load_prac.keys',key_resp_load_prac.keys)
        trials_cogload_practice2_3.addData('key_resp_load_prac.corr', key_resp_load_prac.corr)
        if key_resp_load_prac.keys != None:  # we had a response
            trials_cogload_practice2_3.addData('key_resp_load_prac.rt', key_resp_load_prac.rt)
        # the Routine "practice_cog_load" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
        
    # completed cognitive_load repeats of 'trials_cogload_practice2_3'
    
    
    # ------Prepare to start Routine "stimulus_presentation_4"-------
    continueRoutine = True
    # update component parameters for each repeat
    stim4_5.setFillColor(colors[3])
    stim4_5.setPos([stim_positions[3]])
    stim4_5.setLineColor(colors[3])
    mask4_12.setFillColor(colors[5])
    mask4_12.setPos((stim_positions[3][0]-.0125, stim_positions[3][1]-.0125))
    mask4_12.setLineColor(colors[5])
    mask4_13.setFillColor(colors[6])
    mask4_13.setPos((stim_positions[3][0]+.0125, stim_positions[3][1]-.0125))
    mask4_13.setLineColor(colors[6])
    mask4_14.setFillColor(colors[7])
    mask4_14.setPos((stim_positions[3][0]+.0125, stim_positions[3][1]+.0125))
    mask4_14.setLineColor(colors[7])
    mask4_15.setFillColor(colors[8])
    mask4_15.setPos((stim_positions[3][0]-.0125, stim_positions[3][1]+.0125))
    mask4_15.setLineColor(colors[8])
    # keep track of which components have finished
    stimulus_presentation_4Components = [stim4_5, mask4_12, mask4_13, mask4_14, mask4_15]
    for thisComponent in stimulus_presentation_4Components:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    stimulus_presentation_4Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "stimulus_presentation_4"-------
    while continueRoutine:
        # get current time
        t = stimulus_presentation_4Clock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=stimulus_presentation_4Clock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *stim4_5* updates
        if stim4_5.status == NOT_STARTED and tThisFlip >= fix_time-frameTolerance:
            # keep track of start time/frame for later
            stim4_5.frameNStart = frameN  # exact frame index
            stim4_5.tStart = t  # local t and not account for scr refresh
            stim4_5.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(stim4_5, 'tStartRefresh')  # time at next scr refresh
            stim4_5.setAutoDraw(True)
        if stim4_5.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > stim4_5.tStartRefresh + stim_time-frameTolerance:
                # keep track of stop time/frame for later
                stim4_5.tStop = t  # not accounting for scr refresh
                stim4_5.frameNStop = frameN  # exact frame index
                win.timeOnFlip(stim4_5, 'tStopRefresh')  # time at next scr refresh
                stim4_5.setAutoDraw(False)
        
        # *mask4_12* updates
        if mask4_12.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
        ...
        if mask4_12.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask4_12.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask4_12.tStop = t  # not accounting for scr refresh
                mask4_12.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask4_12, 'tStopRefresh')  # time at next scr refresh
                mask4_12.setAutoDraw(False)
        
        # *mask4_13* updates
        if mask4_13.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask4_13.frameNStart = frameN  # exact frame index
            mask4_13.tStart = t  # local t and not account for scr refresh
            mask4_13.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask4_13, 'tStartRefresh')  # time at next scr refresh
            mask4_13.setAutoDraw(True)
        if mask4_13.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask4_13.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask4_13.tStop = t  # not accounting for scr refresh
                mask4_13.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask4_13, 'tStopRefresh')  # time at next scr refresh
                mask4_13.setAutoDraw(False)
        
        # *mask4_14* updates
        if mask4_14.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask4_14.frameNStart = frameN  # exact frame index
            mask4_14.tStart = t  # local t and not account for scr refresh
            mask4_14.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask4_14, 'tStartRefresh')  # time at next scr refresh
            mask4_14.setAutoDraw(True)
        if mask4_14.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask4_14.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask4_14.tStop = t  # not accounting for scr refresh
                mask4_14.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask4_14, 'tStopRefresh')  # time at next scr refresh
                mask4_14.setAutoDraw(False)
        
        # *mask4_15* updates
        if mask4_15.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
            # keep track of start time/frame for later
            mask4_15.frameNStart = frameN  # exact frame index
            mask4_15.tStart = t  # local t and not account for scr refresh
            mask4_15.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(mask4_15, 'tStartRefresh')  # time at next scr refresh
            mask4_15.setAutoDraw(True)
        if mask4_15.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > mask4_15.tStartRefresh + mask_time-frameTolerance:
                # keep track of stop time/frame for later
                mask4_15.tStop = t  # not accounting for scr refresh
                mask4_15.frameNStop = frameN  # exact frame index
                win.timeOnFlip(mask4_15, 'tStopRefresh')  # time at next scr refresh
    ...
    # set up handler to look after randomisation of conditions etc
    trials_cogload_practice2_4 = data.TrialHandler(nReps=cognitive_load, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='trials_cogload_practice2_4')
    thisExp.addLoop(trials_cogload_practice2_4)  # add the loop to the experiment
    thisTrials_cogload_practice2_4 = trials_cogload_practice2_4.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_practice2_4.rgb)
    if thisTrials_cogload_practice2_4 != None:
        for paramName in thisTrials_cogload_practice2_4:
            exec('{} = thisTrials_cogload_practice2_4[paramName]'.format(paramName))
    
    for thisTrials_cogload_practice2_4 in trials_cogload_practice2_4:
        currentLoop = trials_cogload_practice2_4
        # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_practice2_4.rgb)
        if thisTrials_cogload_practice2_4 != None:
            for paramName in thisTrials_cogload_practice2_4:
                exec('{} = thisTrials_cogload_practice2_4[paramName]'.format(paramName))
        ...
        if key_resp_load_prac.keys in ['', [], None]:  # No response was made
            ...
            if str(correct_ans_cogload).lower() == 'none':
               ...
               key_resp_load_prac.corr = 0;  # failed to respond (incorrectly)
        # store data for trials_cogload_practice2_4 (TrialHandler)
        trials_cogload_practice2_4.addData('key_resp_load_prac.keys',key_resp_load_prac.keys)
        trials_cogload_practice2_4.addData('key_resp_load_prac.corr', key_resp_load_prac.corr)
        if key_resp_load_prac.keys != None:  # we had a response
            trials_cogload_practice2_4.addData('key_resp_load_prac.rt', key_resp_load_prac.rt)
        # the Routine "practice_cog_load" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
        
    # completed cognitive_load repeats of 'trials_cogload_practice2_4'
    ...
    trials_practice.addData('text_14.started', text_14.tStartRefresh)
    trials_practice.addData('text_14.stopped', text_14.tStopRefresh)
    # the Routine "practice_response_presentation" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
...
for thisBlock in block:
    ...
    for thisTrial in trials:
        ...
        # keep track of which components have finished
        stimulus_presentationComponents = [fixation, stim1, mask1_1, mask1_2, mask1_3, mask1_4]
        ...
        # set up handler to look after randomisation of conditions etc
        trials_cogload_1 = data.TrialHandler(nReps=cognitive_load, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=[None],
            seed=None, name='trials_cogload_1')
        thisExp.addLoop(trials_cogload_1)  # add the loop to the experiment
        thisTrials_cogload_1 = trials_cogload_1.trialList[0]  # so we can initialise stimuli with some values
        # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_1.rgb)
        if thisTrials_cogload_1 != None:
            for paramName in thisTrials_cogload_1:
                exec('{} = thisTrials_cogload_1[paramName]'.format(paramName))
        
        for thisTrials_cogload_1 in trials_cogload_1:
            currentLoop = trials_cogload_1
            # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_1.rgb)
            if thisTrials_cogload_1 != None:
                for paramName in thisTrials_cogload_1:
                    exec('{} = thisTrials_cogload_1[paramName]'.format(paramName))
            ...
            # store data for trials_cogload_1 (TrialHandler)
            trials_cogload_1.addData('key_resp_load.keys',key_resp_load.keys)
            trials_cogload_1.addData('key_resp_load.corr', key_resp_load.corr)
            if key_resp_load.keys != None:  # we had a response
                trials_cogload_1.addData('key_resp_load.rt', key_resp_load.rt)
            # the Routine "cog_load" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
            
        # completed cognitive_load repeats of 'trials_cogload_1'
        ...
        # keep track of which components have finished
        stimulus_presentation_2Components = [stim2_2, mask2, mask2_5, mask2_6, mask2_7]
        for thisComponent in stimulus_presentation_2Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        stimulus_presentation_2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        
        # -------Run Routine "stimulus_presentation_2"-------
        while continueRoutine:
            # get current time
            t = stimulus_presentation_2Clock.getTime()
            tThisFlip = win.getFutureFlipTime(clock=stimulus_presentation_2Clock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        # set up handler to look after randomisation of conditions etc
        trials_cogload_2 = data.TrialHandler(nReps=cognitive_load, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=[None],
            seed=None, name='trials_cogload_2')
        thisExp.addLoop(trials_cogload_2)  # add the loop to the experiment
        thisTrials_cogload_2 = trials_cogload_2.trialList[0]  # so we can initialise stimuli with some values
        # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_2.rgb)
        if thisTrials_cogload_2 != None:
            for paramName in thisTrials_cogload_2:
                exec('{} = thisTrials_cogload_2[paramName]'.format(paramName))
        
        for thisTrials_cogload_2 in trials_cogload_2:
            currentLoop = trials_cogload_2
            # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_2.rgb)
            if thisTrials_cogload_2 != None:
                for paramName in thisTrials_cogload_2:
                    exec('{} = thisTrials_cogload_2[paramName]'.format(paramName))
            ...
            if key_resp_load.keys in ['', [], None]:  # No response was made
                ...
                if str(correct_ans_cogload).lower() == 'none':
                   ...
                   key_resp_load.corr = 0;  # failed to respond (incorrectly)
            # store data for trials_cogload_2 (TrialHandler)
            trials_cogload_2.addData('key_resp_load.keys',key_resp_load.keys)
            trials_cogload_2.addData('key_resp_load.corr', key_resp_load.corr)
            if key_resp_load.keys != None:  # we had a response
                trials_cogload_2.addData('key_resp_load.rt', key_resp_load.rt)
            # the Routine "cog_load" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
            
        # completed cognitive_load repeats of 'trials_cogload_2'
        
        
        # ------Prepare to start Routine "stimulus_presentation_3"-------
        continueRoutine = True
        # update component parameters for each repeat
        stim3_3.setFillColor(colors[2])
        stim3_3.setPos([stim_positions[2]])
        stim3_3.setLineColor(colors[2])
        mask3_8.setFillColor(colors[5])
        mask3_8.setPos((stim_positions[2][0]-.0125, stim_positions[2][1]-.0125))
        mask3_8.setLineColor(colors[5])
        mask3_9.setFillColor(colors[6])
        mask3_9.setPos((stim_positions[2][0]+.0125, stim_positions[2][1]-.0125))
        mask3_9.setLineColor(colors[6])
        mask3_10.setFillColor(colors[7])
        mask3_10.setPos((stim_positions[2][0]+.0125, stim_positions[2][1]+.0125))
        mask3_10.setLineColor(colors[7])
        mask3_11.setFillColor(colors[8])
        mask3_11.setPos((stim_positions[2][0]-.0125, stim_positions[2][1]+.0125))
        mask3_11.setLineColor(colors[8])
        # keep track of which components have finished
        stimulus_presentation_3Components = [stim3_3, mask3_8, mask3_9, mask3_10, mask3_11]
        for thisComponent in stimulus_presentation_3Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        stimulus_presentation_3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        
        # -------Run Routine "stimulus_presentation_3"-------
        while continueRoutine:
            # get current time
            t = stimulus_presentation_3Clock.getTime()
            tThisFlip = win.getFutureFlipTime(clock=stimulus_presentation_3Clock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
            
            # *stim3_3* updates
            if stim3_3.status == NOT_STARTED and tThisFlip >= fix_time-frameTolerance:
                # keep track of start time/frame for later
                stim3_3.frameNStart = frameN  # exact frame index
                stim3_3.tStart = t  # local t and not account for scr refresh
                stim3_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(stim3_3, 'tStartRefresh')  # time at next scr refresh
                stim3_3.setAutoDraw(True)
            if stim3_3.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > stim3_3.tStartRefresh + stim_time-frameTolerance:
                    # keep track of stop time/frame for later
                    stim3_3.tStop = t  # not accounting for scr refresh
                    stim3_3.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(stim3_3, 'tStopRefresh')  # time at next scr refresh
                    stim3_3.setAutoDraw(False)
            
            # *mask3_8* updates
            if mask3_8.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
                # keep track of start time/frame for later
            ...
            if mask3_8.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > mask3_8.tStartRefresh + mask_time-frameTolerance:
                    # keep track of stop time/frame for later
                    mask3_8.tStop = t  # not accounting for scr refresh
                    mask3_8.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(mask3_8, 'tStopRefresh')  # time at next scr refresh
                    mask3_8.setAutoDraw(False)
            
            # *mask3_9* updates
            if mask3_9.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
                # keep track of start time/frame for later
            ...
            if mask3_9.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > mask3_9.tStartRefresh + mask_time-frameTolerance:
                    # keep track of stop time/frame for later
                    mask3_9.tStop = t  # not accounting for scr refresh
                    mask3_9.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(mask3_9, 'tStopRefresh')  # time at next scr refresh
                    mask3_9.setAutoDraw(False)
            
            # *mask3_10* updates
            if mask3_10.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
                # keep track of start time/frame for later
            ...
            if mask3_10.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > mask3_10.tStartRefresh + mask_time-frameTolerance:
                    # keep track of stop time/frame for later
                    mask3_10.tStop = t  # not accounting for scr refresh
                    mask3_10.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(mask3_10, 'tStopRefresh')  # time at next scr refresh
                    mask3_10.setAutoDraw(False)
            
            # *mask3_11* updates
            if mask3_11.status == NOT_STARTED and tThisFlip >= mask_onset-frameTolerance:
                # keep track of start time/frame for later
            ...
            if mask3_11.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > mask3_11.tStartRefresh + mask_time-frameTolerance:
                    # keep track of stop time/frame for later
                    mask3_11.tStop = t  # not accounting for scr refresh
                    mask3_11.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(mask3_11, 'tStopRefresh')  # time at next scr refresh
        ...
        # set up handler to look after randomisation of conditions etc
        trials_cogload_3 = data.TrialHandler(nReps=cognitive_load, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=[None],
            seed=None, name='trials_cogload_3')
        thisExp.addLoop(trials_cogload_3)  # add the loop to the experiment
        thisTrials_cogload_3 = trials_cogload_3.trialList[0]  # so we can initialise stimuli with some values
        # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_3.rgb)
        if thisTrials_cogload_3 != None:
            for paramName in thisTrials_cogload_3:
                exec('{} = thisTrials_cogload_3[paramName]'.format(paramName))
        
        for thisTrials_cogload_3 in trials_cogload_3:
            currentLoop = trials_cogload_3
            # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_3.rgb)
            if thisTrials_cogload_3 != None:
                for paramName in thisTrials_cogload_3:
                    exec('{} = thisTrials_cogload_3[paramName]'.format(paramName))
            ...
            if key_resp_load.keys in ['', [], None]:  # No response was made
                ...
                if str(correct_ans_cogload).lower() == 'none':
                   ...
                   key_resp_load.corr = 0;  # failed to respond (incorrectly)
            # store data for trials_cogload_3 (TrialHandler)
            trials_cogload_3.addData('key_resp_load.keys',key_resp_load.keys)
            trials_cogload_3.addData('key_resp_load.corr', key_resp_load.corr)
            if key_resp_load.keys != None:  # we had a response
                trials_cogload_3.addData('key_resp_load.rt', key_resp_load.rt)
            # the Routine "cog_load" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
            
        # completed cognitive_load repeats of 'trials_cogload_3'
        ...
        # set up handler to look after randomisation of conditions etc
        trials_cogload_4 = data.TrialHandler(nReps=cognitive_load, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=[None],
            seed=None, name='trials_cogload_4')
        thisExp.addLoop(trials_cogload_4)  # add the loop to the experiment
        thisTrials_cogload_4 = trials_cogload_4.trialList[0]  # so we can initialise stimuli with some values
        # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_4.rgb)
        if thisTrials_cogload_4 != None:
            for paramName in thisTrials_cogload_4:
                exec('{} = thisTrials_cogload_4[paramName]'.format(paramName))
        
        for thisTrials_cogload_4 in trials_cogload_4:
            currentLoop = trials_cogload_4
            # abbreviate parameter names if possible (e.g. rgb = thisTrials_cogload_4.rgb)
            if thisTrials_cogload_4 != None:
                for paramName in thisTrials_cogload_4:
                    exec('{} = thisTrials_cogload_4[paramName]'.format(paramName))
            ...
            if key_resp_load.keys in ['', [], None]:  # No response was made
                ...
                if str(correct_ans_cogload).lower() == 'none':
                   ...
                   key_resp_load.corr = 0;  # failed to respond (incorrectly)
            # store data for trials_cogload_4 (TrialHandler)
            trials_cogload_4.addData('key_resp_load.keys',key_resp_load.keys)
            trials_cogload_4.addData('key_resp_load.corr', key_resp_load.corr)
            if key_resp_load.keys != None:  # we had a response
                trials_cogload_4.addData('key_resp_load.rt', key_resp_load.rt)
            # the Routine "cog_load" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
            
        # completed cognitive_load repeats of 'trials_cogload_4'
        ...
        # keep track of which components have finished
        stimulus_responseComponents = [resp1, key_resp_stimulus, text_15]
